...
namespace Outlander.Player
{
    public class BotRunState : BotBaseState
    {
        ...
        public BotRunState(BotPSM currentContext, BotMovementStateData playerMovementStateData) : base(currentContext, playerMovementStateData)
        {
        }
        ...
        private void Movement()
        {
            ...
            _context.Player.PlayerStamina.DecreaseStamina(4 * Time.deltaTime);
        }
