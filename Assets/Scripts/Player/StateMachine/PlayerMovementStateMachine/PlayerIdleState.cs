...
namespace Outlander.Player
{
    ...
    {
        public PlayerIdleState(PlayerMovementStateMachine currentContext, PlayerMovementStateData playerMovementStateData) : base(currentContext, playerMovementStateData)
        {
        }
        ...
        public override void CheckSwitchState()
        {
            ...
            else if (_context.IsSprint && _context.IsMoving)
            {
        ...
        public override void EnterState()
        {
            ...
            _context.MovementSubStateIndex = PlayerMovementState.IDLE;
