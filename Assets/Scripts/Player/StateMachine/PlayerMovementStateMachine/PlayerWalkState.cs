...
namespace Outlander.Player
{
    public class PlayerWalkState : PlayerBaseState
    {
        ...
        public PlayerWalkState(PlayerMovementStateMachine currentContext, PlayerMovementStateData playerMovementStateData) : base(currentContext, playerMovementStateData)
        {
        }
        ...
        public override void EnterState()
        {
            ...
            _context.MovementSubStateIndex = PlayerMovementState.WALK;
        ...
        private void Movement()
        {
            ...
            _context.Player.CharacterController.Move(AdjustVelocityToSlope(movement) * Time.deltaTime * (!_context.IsCrouch ? _context.CurrentSpeed : _context.CurrentSpeed * 0.5f));
        }
